			...
			<div>
				<ul id="top-nav">
				    <li><a href="<?= BASE_URL ?>home"><i class="fa fa-home"></i> Home</a></li>
                                    <li><a href="<?= BASE_URL ?>cv"><i class="fa fa-file"></i> CV</a></li>
				    <li><a href="<?= BASE_URL ?>about"><i class="fa fa-lightbulb-o"></i> Artist Statement</a></li>
				    <li><a href="<?= BASE_URL ?>portfolio"><i class="fa fa-image"></i> Portfolio</a></li>
				    <li><a href="<?= BASE_URL ?>resources"><i class="fa fa-gears"></i> Resources</a></li>
				    <li><a href="<?= BASE_URL ?>contact"><i class="fa fa-send"></i> Contact Us</a></li>
				</ul>
			</div>
		</div>
	</header>
